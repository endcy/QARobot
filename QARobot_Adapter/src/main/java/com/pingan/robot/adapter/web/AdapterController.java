...
public class AdapterController {
    ...
    public List keyword(@RequestParam("content") String str) {
        logger.info("ADAPTER keyword receive content:{}", str);
        ...
        logger.info("ADAPTER keyword operation end!");
        return list;
    }
    ...
    public ResultVO answer(@RequestParam("content") String str, @RequestParam("sysId") Integer sysId) {
        logger.info("ADAPTER get receive content:{}", str);
        ...
        logger.info("ADAPTER get operation end!");
        return resultVO;
    }
    ...
    public ResultVO getAnswerById(@RequestParam("id") Integer id, @RequestParam("sysId") Integer sysId) {
        logger.info("ADAPTER id/get receive questionId:{} sysId:{}", id, sysId);
        ResultVO resultVO = ResultVO.FAILURE();
        if (id < 1) {
            resultVO.setMsg("问题不能空！");
        }
        ...
        QAVO qavo = contentService.find(param);
        logger.info("ADAPTER id/get operation end!");
        if (qavo == null)
    ...
    public ResultVO recommend(@RequestParam("content") String str, @RequestParam("sysId") Integer sysId) {
        logger.info("ADAPTER keyword/get receive keyword:{} sysId:{}", str, sysId);
        ResultVO resultVO = ResultVO.FAILURE();
        ...
        logger.info("ADAPTER keyword/get operation end!");
        return resultVO;
    }
}